...
import { Text, View, Alert, SafeAreaView, FlatList, Platform, StatusBar, Dimensions } from 'react-native';
...
export default class MeteorScreen extends Component {
    ...
    renderItem=({item})=>{
        ...
        //Condición sobre meteoros de riesgo bajo
        if(meteor.threat_score<=30){
            bg_img=require("../assets/meteor_bg1.png");
            speed=require("../assets/meteor_speed1.gif");
            size=100
        }
        //Condición sobre meteoros de riesgo medio
        else if(meteor.threat_score<=75){
            bg_img=require("../assets/meteor_bg2.png");
            speed=require("../assets/meteor_speed2.gif");
            size=150
        } 
        //Condición sobre meteoros de riesgo alto
        else{
